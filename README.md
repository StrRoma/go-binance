...
[![Build Status](https://travis-ci.org/StrRoma/go-binance.svg?branch=master)](https://travis-ci.org/StrRoma/go-binance)
[![GoDoc](https://godoc.org/github.com/StrRoma/go-binance?status.svg)](https://godoc.org/github.com/StrRoma/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/StrRoma/go-binance)](https://goreportcard.com/report/github.com/StrRoma/go-binance)
[![codecov](https://codecov.io/gh/StrRoma/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/StrRoma/go-binance)
...
```shell
go get github.com/StrRoma/go-binance
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/StrRoma/go-binance) for full references.
